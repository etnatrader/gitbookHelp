...
Use this condition to apply the order review mechanism to all orders placed during specific trading hours on the exchange specified in the \#9 condition \(Execution Venue\). For example, you can use this rule to review all orders placed during the pre- and post-market hours on the London Stock Exchange.

...
{% hint style="warning" %}
In order to retrieve the list of all equities with a particular pattern, you must use an [authorization token](../../authentication/requesting-tokens/) of an administrator. Using authorization tokens of regular users will lead to the 401 status code.
{% endhint %}

...
{% hint style="warning" %}
In order to remove a specific security \(by its ticker symbol\) from a specific watchlist of a particular user, you must use an [authorization token]() of an administrator. Using authorization tokens of regular users will lead to the 401 status code.
{% endhint %}

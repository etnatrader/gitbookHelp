...
{% hint style="warning" %}
In order to list a user's positions in a particular security, you must use an [authorization token]() of an administrator. Using authorization tokens of regular users will lead to the 401 status code.
{% endhint %}

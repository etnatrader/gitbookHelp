...
{% hint style="warning" %}
In order to create a multi-leg allocation request, you must use an [authorization token](../authentication/) of an administrator. Using authorization tokens of regular users will lead to the 401 status code.
{% endhint %}

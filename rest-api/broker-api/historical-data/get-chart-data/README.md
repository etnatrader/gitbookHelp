...
| Difference | This is the difference between the price at the `StartDate` and the price registered at the time specified in `Time`. |
| Price | The price registered at the date specified in `Time`. |

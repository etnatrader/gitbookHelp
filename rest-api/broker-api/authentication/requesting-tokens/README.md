---
description: Perform regular authentication
---
...
To see how initial authentication can be performed in code, feel free to examine our [sample requests](../../code-samples/basic-authentication.md) in a dedicated article.

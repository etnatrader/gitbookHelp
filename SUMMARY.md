...
* [Trading API](web-api/trading-api/README.md)
  ...
  * [Paperless Settings](web-api/trading-api/paperless-settings/README.md)
    * [Get Paperless Settings By Account Id](web-api/trading-api/paperless-settings/get-paperless-settings-by-account-id.md)
    * [Create Paperless Settings](web-api/trading-api/paperless-settings/create-paperless-settings.md)
    * [Update Paperless Settings By Id](web-api/trading-api/paperless-settings/update-paperless-settings-by-id.md)
    * [Create Default Paperless Settings](web-api/trading-api/paperless-settings/create-default-paperless-settings.md)
